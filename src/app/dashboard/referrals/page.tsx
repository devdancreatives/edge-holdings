...
export default function ReferralsPage() {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            {/* Header */}
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Referral Program</h1>
                <p className="text-zinc-600 dark:text-zinc-400">Earn 0.5% commission on every investment made by your referrals</p>
            </div>
            ...
            <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-6 backdrop-blur-sm">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">Your Referral Code</h2>
                            <p className="text-sm text-zinc-600 dark:text-zinc-400">Share this code to earn rewards</p>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                        <div className="flex-1 py-2 px-4 rounded-lg bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex-1 py-2 px-4 rounded-lg bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 truncate">
                            <p className="text-[10px] font-medium text-zinc-500 mb-1">Referral Link</p>
                            <p className="text-[20px] font-mono text-zinc-700 dark:text-zinc-300 truncate">
                        ...
                        <button
                            ...
                            title="Copy Link"
                            className="py-2 px-4 rounded-lg bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:bg-zinc-700 transition-all text-zinc-900 dark:text-white flex items-center gap-2 font-semibold self-stretch border border-zinc-700"
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-6">
                    ...
                    <p className="text-3xl font-bold text-zinc-900 dark:text-white">${stats?.totalEarnings?.toFixed(2) || '0.00'}</p>
                </div>
            </div>
                ...
                <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-6">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">Next Bonus: {nextBonus.label}</h3>
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-xs text-zinc-600 dark:text-zinc-400">Bonus reward</p>
                        </div>
                    </div>
            ...
            <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-6">
                ...
                {referralsLoading ? (
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-zinc-600 dark:text-zinc-400">No referrals yet</p>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-zinc-200 dark:border-zinc-800">
                                    ...
                                    <th className="text-left py-3 px-4 text-sm font-medium text-zinc-600 dark:text-zinc-400">Joined</th>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-zinc-600 dark:text-zinc-400">Status</th>
                                    <th className="text-right py-3 px-4 text-sm font-medium text-zinc-600 dark:text-zinc-400">Earnings</th>
                                </tr>
                            </thead>
                            <tbody>
                                {referrals.map((referral: any) => (
                                    <tr key={referral.id} className="border-b border-zinc-200 dark:border-zinc-800/50 hover:bg-zinc-100 dark:bg-zinc-800/30 transition-colors">
                                        <td className="py-3 px-4">
                                            <p className="text-zinc-900 dark:text-white font-medium">{referral?.referee?.fullName}</p>
                                        ...
                                        <td className="py-3 px-4 text-right">
                                            <p className="text-zinc-900 dark:text-white font-semibold">${referral.totalEarnings?.toFixed(2) || '0.00'}</p>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
            ...
            <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 p-6">
                ...
                {earningsLoading ? (
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-zinc-600 dark:text-zinc-400">No earnings yet</p>
                    ...
                    <div className="space-y-3">
                        {earnings.map((earning: any) => (
                            <div
                                key={earning.id}
                                className="flex items-center justify-between p-4 rounded-lg bg-zinc-100 dark:bg-zinc-800/30 hover:bg-zinc-100 dark:bg-zinc-800/50 transition-colors"
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-zinc-900 dark:text-white font-medium">Commission from {earning.referredUser?.fullName}</p>
                                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <div className="rounded-xl border border-yellow-500/20 bg-yellow-500/5 p-6">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="text-zinc-900 dark:text-white font-semibold mb-1">Withdrawal Information</h3>
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
